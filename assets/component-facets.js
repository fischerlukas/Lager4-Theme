...
// Guard: this file may be loaded by both the shelf-filter section and the
// product-grid/search sections. Skip re-execution if already registered so
// the top-level class declarations and customElements.define calls don't clash.
if (!(window.customElements && customElements.get('facet-filters-form'))) {
